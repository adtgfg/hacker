#Coded By So-St.E.M.E  ... And Copyright Ofc xD 
# : So-St.E.M.E  To Know Some Methods ABout Hacking/Cracking/Crading ....
#Sate !
#Sate !
#Sate !
import random 
...
######## Work ########
def steam() :
 print("""  Steam Generator (c)So-St.E.M.E  """)
 ...
 try :
   for az in range(int(zz)) :
    ...
    print(az+1,")",mark," by So-St.E.M.E ")
   ...
   if so =='y' or so =='Y':
    ...
    exit()
	   	 ...
	   	 pass
def hma() :
 print("""  Hidemyass Generator (c)So-St.E.M.E  """)
 zz=input('Enter Number Keys > ')
 try :
   for az in range(int(zz)) :
    urname = string.ascii_letters + string.digits
   ...
   if so =='y' or so =='Y':
        ...
        exit()
	   	 ...
	   	 pass
def g2a() :
  print("""  G2A Generator (c)So-St.E.M.E  """)
  zz=input('Enter Number Keys > ')
  try :
   for az in range(int(zz)) :
    urname = string.ascii_letters + string.digits
...
def gplay() :
 print("""  Googleplay Generator (c)So-St.E.M.E  """)
 zz=input('Enter Number Keys > ')
 int(zz)
 try :
   for az in range(int(zz)) :
   ...
   if so =='y' or so =='Y':
        ...
        exit()
	   	 ...
	   	 pass
def express() :
 print("""  Express Vpn Generator (c)So-St.E.M.E  """)
 zz=input('Enter Number Keys > ')
 try :
   for az in range(int(zz)) :
    urname = string.ascii_letters + string.digits
    urname1 = ''.join(choice(urname) for _ in range(22))
    print(az+1,")","E"+ urname1.upper()," by So-St.E.M.E ")
   ...
   if so =='y' or so =='Y':
        ...
        exit()
	   	 ...
	   	 pass
def karta() :
 print("""  7ammass Generator (c)So-St.E.M.E  """)
 zz=input('Enter Number Keys > ')
 try :
   for az in range(int(zz)) :
    gothar = string.digits
    gothar69 = ''.join(choice(gothar) for _ in range(14))
    print(az+1,")",gothar69," by So-St.E.M.E ")
...
def Norton() :
 ...
 try :
   for az in range(int(zz)) :
    ...
    print(az+1,")",'V'+gothar69.upper()," by So-St.E.M.E ")
   ...
   if so =='y' or so =='Y':
        ...
        exit()
         ...
         pass
def avgantiv() :
 print("""  AVGAntivurus Generator (c)So-St.E.M.E  """)
 zz=input('Enter Number Keys > ')
 try :
   for az in range(int(zz)) :
    ...
    print(az+1,")",nanatsu," by So-St.E.M.E ")
   ...
   if so =='y' or so =='Y':
        ...
        exit()
         ...
         pass
def esetss() :
 print("""  ESet Smart Security Generator (c)So-St.E.M.E  \n\n  1) Keyz\n  2) Accounts  """)
 psyco = input('$ ')
 if psyco == '1':
  zz=input('Enter Number Keys > ')
  try :
...
def photoshop():
  print(""" PhotoShop Cs6 Genrator (c)So-St.E.M.E  """)
  zz=input('Enter Number Keys > ')
  try:
    for az in range(int(zz)) :
    ...
    if so =='y' or so =='Y':
        ...
        exit()    
           ...
           pass
def winkeyz():
  print(""" WinDows Genrator (c)So-St.E.M.E  """)
  zz=input('Enter Number Keys > ')
  try:
    for az in range(int(zz)) :
        meliodas = string.ascii_letters + string.digits
    ...
    if so =='y' or so =='Y':
        ...
        exit() 
           ...
           pass 
def amazon():
 print("""  Amazon Generator (c)So-St.E.M.E  """)
 zz=input('Enter Number Keys > ')
 try :
  for az in range(int(zz)) :
    urname = string.ascii_letters + string.digits
...
def abo():
 print("""
 Name : Ahmed
 Nickname : So-St.E.M.E 
 Country : Yamen
 Mail Me : Dream0@protonmail.com
 Github : https://github.com/adtgfg
 Youtube : So-St.E.M.E  """)
 exit()
######## Menu ########
...
def main():
 logo = ("""                                     
     ...
     `#@@@@@@##;#+''++'#;##@@@#####     
      ...
      ,#@@@@@+++++#''#+++++######@    #ZeroEye - Key Generator 
       ####@@+++++++#++++++######.    #(Updated in Aug2018) By So-St.E.M.E 
 ...
 """)
 print(logo)
 print(' Hello '+getpass.getuser()+' : '+time.asctime( time.localtime(time.time()) ),'\n [!] اهلا وسهلا بالجميع مطور الاداه  نجم الجنوب من فريق E.M.E\nBan Or CountryNotAvaible)\n [1]  Steam ')
 print(" [2]  Express ")
 print(" [3]  Hidemyass ")
 ...
 if zack == '1':
    ...
    print("  Go To http://So-St.E.M.E .ga/cc.html Or Contact Me")
 elif zack == '69' :
    abo()
 else :
